...
th, td { border: 1px solid black; padding: 4px 10px; text-align: center; }
...
try:
    filepath = "/mnt/c/Users/rifra/Downloads/Surat_Keterangan_Kerja_BSI_v2.doc"
    with codecs.open(filepath, "w", "utf-8") as f:
        f.write(html)
    print("File .doc v2 berhasil dibuat!")
